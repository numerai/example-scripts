...
| File | Description |
|------|-------------|
| `numerai/v5.3/full.parquet` | Full training data |
| `numerai/v5.3/full_benchmark_models.parquet` | Benchmark model predictions |
| `numerai/v5.3/downsampled_full.parquet` | Every 4th era (fast iteration) |
| `numerai/v5.3/downsampled_full_benchmark_models.parquet` | Downsampled benchmarks |
...
- **Data lives under `numerai/<data_version>/`** (e.g. `numerai/v5.3/`), which is often gitignored locally
