...
This repository contains example scripts and an agentic research framework for the [Numerai Tournament](https://numer.ai/). AI coding agents can use this file to understand how to help with Numerai-related tasks.
...
└── *.ipynb                        # Root-level example notebooks
```
