...
def summarize_prediction_file_with_bmc(
    ...
    bmc_summary = summarize_scores(per_era_recent)
    ...
    if small_bmc_baseline_path is not None:
        ...
        if baseline_path.exists():
            ...
            small_bmc_summary = summarize_scores(per_era_small_recent)
