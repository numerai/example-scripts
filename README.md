...
- Dimensions: ~500K rows x ~1K columns
...
- Description: The predictions generated by the example model on the numerai_validation_data

- Dimensions: ~500K rows x 1 column
